...
Проект Personal_diary является курсовой работой и представляет собой Веб-приложение для ведения личного дневника.
Данный проект разделен на два приложения, одно из которых отвечает за авторизацию и регистрацию пользователя в приложении,
второе содержит непосредственно контент самого личного дневника, в него входит возможность создавать, редактировать,
удалять и изменить записи, также предусмотрены права доступа, только автор может видеть собственные записи.
